...
import { idlFactory } from './edutrack.did.js';
export { idlFactory } from './edutrack.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_EDUTRACK;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./edutrack.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the edutrack canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./edutrack.did.js")._SERVICE>}
 */
export const edutrack = createActor(canisterId);
